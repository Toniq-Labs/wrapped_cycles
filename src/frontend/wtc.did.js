export default ({ IDL }) => {
  ...
  const AccountIdentifier_3 = AccountIdentifier_2;
  ...
  return IDL.Service({
    ...
    'burn' : IDL.Func([Balance_2, Callback], [IDL.Bool], []),
    ...
    'minCyclesThreshold' : IDL.Func([], [Balance_2], ['query']),
    'mint' : IDL.Func([IDL.Opt(User_2)], [], []),
